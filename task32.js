...
var current_users = ["admin", "Eric", "Khuzaima", "Ayaan", "aqsa"];
var new_users = ["admin", "aqsa", "Muqaddus", "Aliza", "Harry"];
new_users.forEach(function (newUsername) {
    var lowerCase = newUsername.toLowerCase();
    if (current_users.map(function (c_users) { return c_users.toLocaleLowerCase(); }).includes(lowerCase)) {
