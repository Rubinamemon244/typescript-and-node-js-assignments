...
//console.log(album2);
//console.log(album3);
function myAlbum2(naatkhuwanName, albumTitle, numberOfNaats) {
    return { naatkhuwanName: naatkhuwanName, albumTitle: albumTitle, numberOfNaats: numberOfNaats };
}
var album1 = myAlbum2("Owais Qadri", "Mujhay dur pay phir bulana", 30);
var album2 = myAlbum2("Arsalan Qadri", "Har wqt tasawwar m Madinay ki gali", 25);
var album3 = myAlbum2("Ghulam Muatafa Qadri", "Chor fikr dunia ki");
console.log(album1);
console.log(album2);
console.log(album3);
