...
// return size + label
//} 
//let myFuntion = make_shirt("large", " I love Typescript");
//console.log(myfun);
//function make_shirt(label: string, size: string = "Larger") {
//  return size + label
//}
...
var myfuntion = make_shirt(" any size", " I love Typescript");
console.log(myfuntion);
//console.log("\n")
//function make_shirt(label: string,size: string ){
// return size + label
//}
//let myfuntion3 = make_shirt(" Any size" ," I love Typescript");
//console.log(myfuntion);
